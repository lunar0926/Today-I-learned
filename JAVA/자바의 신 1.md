...
<p> 이번 연습문제를 풀면서 배운 것은 참조 자료형, 객체, 객체 배열에 대한 지식 자체도 있겠지만 문제해결을 하는 과정이 어떻게 되는지를 조금이나마 배울 수 있었다. 내가 잘 모르는 부분, 막힌 부분에 대해서 내가 어떤 점을 몰라서, 어떤 개념에 대한 이해가 부족해서 그런지를 명확하게 인식하지 못하면 문제 해결을 할 수가 없다. </p>
